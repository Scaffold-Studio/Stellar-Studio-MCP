...
export const networks = {
  standalone: {
    ...
    contractId: "CD2R2DMIA5GXO2QE7T4IEYFDM6PPCDWCPXJ6MCTO3PVEQVF6PVQBW4DS",
  }
} as const

export const ExampleContractError = {
...
export class Client extends ContractClient {
  static async deploy<T = Client>(
        ...
        {admin, manager, initial_supply, name, symbol, decimals}: {admin: string, manager: string, initial_supply: i128, name: string, symbol: string, decimals: u32},
    ...
    return ContractClient.deploy({admin, manager, initial_supply, name, symbol, decimals}, options)
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABAAAAAAAAAAAAAAAFEV4YW1wbGVDb250cmFjdEVycm9yAAAAAQAAAAAAAAAMVW5hdXRob3JpemVkAAAAAQ==",
        "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAYAAAAAAAAABWFkbWluAAAAAAAAEwAAAAAAAAAHbWFuYWdlcgAAAAATAAAAAAAAAA5pbml0aWFsX3N1cHBseQAAAAAACwAAAAAAAAAEbmFtZQAAABAAAAAAAAAABnN5bWJvbAAAAAAAEAAAAAAAAAAIZGVjaW1hbHMAAAAEAAAAAA==",
